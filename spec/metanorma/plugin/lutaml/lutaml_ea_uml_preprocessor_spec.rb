...
RSpec.describe Metanorma::Plugin::Lutaml::LutamlEaUmlPreprocessor do
  describe "#process" do
    ...
    context "when parsing simple EA XMI file" do
      ...
      context "when there is no config file" do
        ...
        context "when rendering input" do
      ...
      context "when there is config file with context_name and template_path" do
        ...
        context "when rendering packages and classes" do
          it "shows the name of the context" do
            expect(output)
              .to include("Name of the Lutaml UML Document: EA_Model")
          end
          ...
          it "contains classes in package Another" do # rubocop:disable RSpec/ExampleLength
            expect(output)
    ...
    context "when parsing plateau EA XMI file" do
      let(:example_file) do
      ...
      context "when there is config file with context_name and template_path" do
        ...
        context "when rendering packages and classes" do
          ...
          it "contains classes in package bldg" do # rubocop:disable RSpec/ExampleLength
            [
              "Name",
              "Definition",
              "Attributes",
        ...
        context "when rendering a specific class (e.g. DataQualityAttribute)" do
          let (:input) do
            <<~TEXT
              = Document title
              Author
        ...
        context "when rendering a specific class with generalization " \
          ...
          it "shows inherited_props" do # rubocop:disable RSpec/ExampleLength
            [
              "gml:description",
              "gml:name",
              "gml:boundedBy",
    ...
    context "when parsing plateau EA QEA file" do
      let(:example_file) do
      ...
      context "when there is config file with context_name and template_path" do
        ...
        context "when rendering a specific class with inherited attributes " \
                "and inherited associations (e.g. ConstructionInstallation)" do
          let (:input) do
            <<~TEXT
              = Document title
              Author
          ...
          it "shows size of properties" do
            [
              ...
              "Inherited Association Attributes 9",
            ].each do |td|
              expect(output).to have_tag("th", text: /#{td}/)
            end
          end
