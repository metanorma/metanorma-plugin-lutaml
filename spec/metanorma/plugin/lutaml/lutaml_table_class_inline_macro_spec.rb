...
RSpec.describe Metanorma::Plugin::Lutaml::LutamlTableClassInlineMacro do
  describe "#process" do
    ...
    let(:input) do
      <<~TEXT
        ...
        This is lutaml_table_class::[package="ISO 19135 Procedures for item registration XML", name="RE_Register"] class
      TEXT
    end
    let(:output) do
