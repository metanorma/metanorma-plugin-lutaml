...
[source,adoc]
-----
lutaml_gml_dictionary::["/path/to/dictionary.xml",source="source_string",template="/path/to/template.liquid"]
-----
...
* `template="/path/yo/template.liquid"` specifies the liquid template.
...
`[lutaml_gml_dictionary,"/path/to/dictionary.xml",source="source_string"]`.
