  ...
  describe "#process" do
    context "when sources are in separate files" do
      ...
      context "Nested files support" do
        ...
        let(:parent_file1) do
          datastruct_fixtures_path("parent_file_1.#{extension}")
        end
        let(:parent_file2) do
          datastruct_fixtures_path("parent_file_2.#{extension}")
        end
        let(:parent_file3) do
          datastruct_fixtures_path("parent_file_3.#{extension}")
        end
        let(:input) do
          <<~TEXT
            = Document title
            ...
            {% assign data = path | loadfile: "./spec/fixtures/lutaml/datastruct/" %}
